...
const double COMMON_SPEED_LIMIT = 50 / 2.237; // m/s
...
// Trajectory Weights
const double TRAJECTORY_COLLISION_WEIGHT = 0;
const double TRAJECTORY_BUFFER_WEIGHT = 1e5;
...
const double TRAJECTORY_MAX_ACCEL_WEIGHT = 1e9;
const double TRAJECTORY_TOTAL_ACCEL_WEIGHT = 10;
const double TRAJECTORY_MAX_JERK_WEIGHT = 1e9;
...
const double TRAJECTORY_EXCEEDS_SPEED_LIMIT_WEIGHT = 1e9;
const double TRAJECTORY_LATERAL_OFFSET_COST = 1e6;

// Trajectory Times
const int TRAJECTORY_N_EVAL_TIME_STEPS = 40; // number of time steps at which to evaluate trajectory of host and targets WAS 32
...
const double LANE_SELECTOR_MIN_REAR_TTC = 5.0; // in seconds
...
const double LANE_SELECTOR_LONGITUDINAL_T_HORIZON = 4.5; // time (in seconds) at which host advance calculated WAS 3
const double LANE_SELECTOR_MIN_PROGRESS_DELTA = 7.5; // an optimal lane must yield at least this much more
...
const double LANE_SELECTOR_OPTIMAL_LANE_FILTER_TIME = 1; // optimal lane must remain unchanged for this time (in seconds)
